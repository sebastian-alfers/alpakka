 ...
 */
@InternalApi private[amqp] final class AmqpSimpleFlowStage[T](classSettings: AmqpWriteSettings)
  ...
  override def createLogicAndMaterializedValue(inheritedAttributes: Attributes): (GraphStageLogic, Future[Done]) = {
    ...
    (new AbstractAmqpFlowStageLogic[T](classSettings, streamCompletion, shape) {
